...
class RegressionHead_FCN(nn.Module):
    def __init__(self, lossID, weights=None, lstm_hidden_size=None):
        ...
        # num_fc_features = {"inception_3b/1x1": 14080, "loss1/conv": 2560, "loss3/conv": 2688}  # 54*96
        num_fc_features = {"inception_3b/1x1": 65664, "loss1/conv": 14976, "loss3/conv": 48384} # 270*480
        # num_fc_features = {"inception_3b/1x1": 180480, "loss1/conv": 44160, "loss3/conv": 187488}  # 540*960
        nc_cls = [1024, 2048] if lstm_hidden_size is None else [lstm_hidden_size*4, lstm_hidden_size*4]
