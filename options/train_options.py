...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--print_freq', type=int, default=10, help='after every $print_freq percentage of iters, show the training results on console, 0 for print every iters')
        ...
        self.parser.add_argument('--pretrained_model', type=str, help='pretrained FCN model')
