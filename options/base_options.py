...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--loadSize', nargs='+', type=int, default=256, help='scale images to this size, one value as square side length, two values as height and width')
        self.parser.add_argument('--fineSize', nargs='+', type=int, default=224, help='then crop to this size, one value as square side length, two values as height and width')
        ...
        self.parser.add_argument('--model', type=str, default='posenet', choices=['posenet', 'poselstm', 'fcnlstm'], help='chooses which model to use. [posenet | poselstm]')
